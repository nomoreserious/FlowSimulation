...
namespace FlowSimulation.Helpers.DesignPatterns
{
	...
	public class StringEnum
	{
        ...
        public static bool TryParse(Type type, string stringValue, out object value)
        {
            value = Parse(type, stringValue, false);
            return value != null;
        }
